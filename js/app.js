...
// Show all the products in the UI:
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `<div class="single-product ms-5 mt-5">
      <div>
    <img class="product-image" src=${image}></img>
      </div>
      <div class="mt-4 pd-text">
      <h3>${product.title}</h3>
      <p>Category: ${product.category}</p>
      <h2>Price: $ ${product.price}</h2>
      <p>Rating: ${rating.rate}/5 <span class="ms-3">Rate Count: ${rating.count}</span> </p>
      </div>
      <div class="pd-btn pb-3">
...
// Updating Delivery Charge and Total Tax:
